...
local t = '*◍ عشان تسوي حساب لازم تختار نوع البطاقة*\n\n[🎮 َِ𝙒َِ𝘦َِ𝙇َِ𝙘َِ𝘰َِ𝘮َِ𝘦 َِ𝙏َِ𝘰 َِ𝘴َِ𝘰َِ𝘶َِ𝘳َِ𝙘َِ𝘦 َِ𝙏ِ𝘪َِ𝘎َِ𝘦َِ𝘳](t.me/UY_X6 )'
local m = "https://t.me/DEV_MEDOU/4" 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'ماستر', callback_data=senderr..'/master'},{text = 'فيزا', callback_data=senderr..'/visaa'},{text = 'اكسبرس', callback_data=senderr..'/express'},
},
{
...
send(msg.chat_id,msg.id, "*◍ حوالة صادرة من بنك تايجر\n\n◍ المرسل ⇿ "..news.."\n◍ الحساب رقم ⇿* `"..cccc.."`\n*◍ نوع البطاقة ⇿ "..uuuu.."\n◍ المستلم ⇿ "..newss.."\n◍ الحساب رقم ⇿* `"..text.."`\n*◍ نوع البطاقة ⇿ "..fsvhh.."\n◍ خصمت 10% رسوم تحويل\n◍ المبلغ ⇿ "..convert_mony.." جنيه 💵 *","md",true)
send(fsvhhh,0, "*◍ حوالة واردة من بنك تايجر\n\n◍ المرسل ⇿ "..news.."\n◍ الحساب رقم ⇿* `"..cccc.."`\n*◍ نوع البطاقة ⇿ "..uuuu.."\n◍ المبلغ ⇿ "..convert_mony.." جنيه 💵 *","md",true)
Redis:del(Fast.."trans" .. msg.chat_id .. ":" .. senderr) 
Redis:del(Fast.."transn" .. senderr)
else
send(msg.chat_id,msg.id, "*◍ مافيه حساب بنكي كذا *","md",true)
